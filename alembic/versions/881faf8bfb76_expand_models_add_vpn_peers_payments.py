...
def upgrade():
    ...
    op.add_column('tariffs', sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('NOW()'), nullable=False))
    ...
    op.add_column('user_tariffs', sa.Column('status', sa.String(), nullable=False, server_default='active'))
    with op.batch_alter_table('user_tariffs') as batch_op:
        batch_op.alter_column('started_at', existing_type=sa.TIMESTAMP(), type_=sa.DateTime(timezone=True), existing_nullable=True, nullable=False)
        batch_op.create_unique_constraint('uix_user_tariff_start', ['user_id', 'tariff_id', 'started_at'])
